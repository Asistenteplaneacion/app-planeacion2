const ResponsableComponente = require('../models/responsableComponenteModel')

exports.responsableComponente = async (req, res) => {
    ...
    switch (method) {
        case 'GET':
            try {
                const resultado = await ResponsableComponente.find()
